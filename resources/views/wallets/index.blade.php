                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            @foreach($wallets as $wallet)
                                              ...
                                              <tr>
                                                <td><img src="{{$wallet->name}}" height="50" width="50"></td>
                                                <td>{{ $wallet->taken == 0 ? "No" : "Yes" }}</td>
                                                <td>{{ $wallet->created_at->toFormattedDateString() }}</td>
                                                <td>
                                                  <a href="#" class="del btn btn-sm btn-outline-danger" data-id="{{$wallet->id}}"><span class="icon-trash"></span> delete</a> 
                                                </td>
                                              </tr>
